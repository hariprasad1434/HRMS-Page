...
import LogoutIcon from "../../Assests/logout 01.png"
        ...
        >
          ...
          >
            <MenuItem onClick={handleProfileClick}>
              <img src={personicon} alt="profile" style={{ width: 20, height: 20, marginRight: 8,fontFamily:"Lexend" }} />
              My Profile
            </MenuItem>
            <Divider />
            <MenuItem onClick={handleLogoutClick} sx={{ color: "#f44336" }}>
              <img src={LogoutIcon} alt="logout" style={{ width: 20, height: 20, marginRight: 8,fontFamily:"Lexend" }} />
              Logout
            </MenuItem>
          </Menu>
        </Card>
